...
const setDatGuiPropertyCss = (propertyText, liCssString, spanCssString = '') => {
...
export const updateTryResNetButtonDatGuiCss = () => {
 ...
 */
export async const renderToCanvas = (a, ctx) => {
 ...
 */
export const renderImageToCanvas = (image, size, canvas) => {
  canvas.width = size[0];
 ...
 */
export const drawHeatMapValues = (heatMapValues, outputStride, canvas) => {
  const ctx = canvas.getContext('2d');
  const radius = 5;
 ...
 * https://medium.com/tensorflow/real-time-human-pose-estimation-in-the-browser-with-tensorflow-js-7dd0bc881cd5
 */
export const drawOffsetVectors = (
